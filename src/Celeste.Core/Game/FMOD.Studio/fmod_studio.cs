...
namespace FMOD.Studio
{
    ...
    public struct System
    {
        ...
        public RESULT getLowLevelSystem(out FMOD.System lowlevelsystem)
        {
            return getCoreSystem(out lowlevelsystem);
        }
        ...
        public static bool operator ==(System a, string b)
        {
            return b is null && !a.isValid();
        }
        ...
        public static bool operator ==(string a, System b)
        {
            return b == a;
        }
        ...
        {
            return obj is System other && other.handle == handle;
        }
    ...
    public struct EventDescription
    {
        ...
        public static bool operator ==(EventDescription a, string b)
        {
            return b is null && !a.isValid();
        }
        ...
        public static bool operator ==(string a, EventDescription b)
        {
            return b == a;
        }
        ...
        public override bool Equals(object obj)
        {
            return obj is EventDescription other && other.handle == handle;
        }
    ...
    public struct EventInstance
    {
        ...
        public static implicit operator EventInstance(string value)
        {
        ...
        public static bool operator ==(EventInstance a, string b)
        {
            return b is null && !a.isValid();
        }
        ...
        public static bool operator ==(string a, EventInstance b)
        {
            return b == a;
        }
        ...
        public override bool Equals(object obj)
        {
            return obj is EventInstance other && other.handle == handle;
        }
